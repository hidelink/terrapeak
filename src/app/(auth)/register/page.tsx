...
const registerAction = async (formData: FormData) => {
  ...
  if (!email || !password || !name) {
    redirect("/register?error=Todos%20los%20campos%20son%20requeridos");
  }
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm text-muted">
              <div className="rounded-2xl border border-border/60 bg-base/70 p-4">
                <p className="text-xs uppercase tracking-wide">Planes</p>
              ...
              <div className="rounded-2xl border border-border/60 bg-base/70 p-4">
                ...
                <p className="text-lg font-semibold text-accent">500+</p>
              </div>
            </div>
          </div>
